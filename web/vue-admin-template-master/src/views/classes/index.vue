  ...
  <div class="app-container">
    ...
    >
      ...
      >
        ...
        <el-form-item label="起付标准" prop="empId">
          <el-select
            v-model="newClass.empId"
            placeholder="请选择"
            style="width: 100%"
          >
            <el-option
        ...
        <el-form-item>
          <el-button type="primary" @click="validateForm('newClassForm')"
            >保存</el-button
          >
    ...
    <el-dialog title="编辑班级" :visible.sync="editDialogVisible" width="30%">
      ...
      >
        ...
        <el-form-item>
          <el-button type="primary" @click="validateForm('editClassForm')"
            >保存</el-button
          >
    ...
    <el-table :data="tableData" style="width: 100%" border>
      ...
      <el-table-column
        align="center"
        label="开课时间"
        :formatter="(row) => row.beginTime.split('T')[0]"
      ></el-table-column>
      <el-table-column
        align="center"
        label="结课时间"
        :formatter="(row) => row.endTime.split('T')[0]"
      ></el-table-column>
      <el-table-column prop="masterName" label="起付标准" align="center">
...
export default {
  data() {
    return {
      ...
      rules: {
        ...
        empId: [{ required: true, message: "请选择班主任", trigger: "change" }],
      },
    };
  },
  ...
  mounted() {
    this.page();
    findAll().then((result) => {
      this.masterList = result.data.data.map((item) => ({
        id: item.id,
        name: item.name,
      }));
    });
