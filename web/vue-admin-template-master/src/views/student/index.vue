  ...
  <div class="app-container">
    ...
    >
      <el-form
        ...
        size="mini"
      >
        <el-form-item label="医疗人员类别" :rules="rules.name" prop="name">
        ...
        <!-- <el-form-item label="最高学历">
          <el-select
            v-model="editStudent.education"
            placeholder="请选择"
            value-key="student.education"
            style="width: 100%"
          >
            <el-option
        ...
        <el-form-item label="医院等级" prop="classId">
          <el-select
            v-model="editStudent.classId"
            placeholder="请选择"
            style="width: 100%"
          >
            <!-- 
        ...
        <el-form-item>
          <el-button type="primary" @click="validateForm('editStudentForm')"
            >提交</el-button
          >
    ...
    >
      ...
      >
        ...
        <el-form-item label="医院等级" :rules="rules.classes" prop="classes">
          <el-select
        ...
        <el-form-item>
          <el-button type="primary" @click="validateForm('newStudentForm')"
            >提交</el-button
          >
    ...
    >
      <el-form ref="form" label-width="80px" size="mini">
        <el-form-item label="标准修改">
          <el-input v-model="score">{{ score }}</el-input>
        </el-form-item>

        <el-form-item>
          <el-button type="primary" @click="dis(student.id, score)"
            >提交</el-button
          >
    ...
    <template>
      ...
      >
        ...
        <el-table-column prop="classes" label="医院等级" align="center">
        ...
        <!-- <el-table-column align="center" width="80" label="最高学历">
          <template slot-scope="scope">
            <span style="margin-right: 10px" v-if="scope.row.education == 1"
              >初中</span
            >
            <span style="margin-right: 10px" v-if="scope.row.education == 2"
              >高中</span
            >
            <span style="margin-right: 10px" v-if="scope.row.education == 3"
              >大专</span
            >
            <span style="margin-right: 10px" v-if="scope.row.education == 4"
              >本科</span
            >
            <span style="margin-right: 10px" v-if="scope.row.education == 5"
              >硕士</span
            >
            <span style="margin-right: 10px" v-if="scope.row.education == 6"
              >博士</span
            >
          </template>
        </el-table-column> -->
